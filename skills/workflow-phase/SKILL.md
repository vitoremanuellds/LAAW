...
6. If replanning: fold in what's already complete rather than discarding
   ...
   version).
7. Stop for phase review — see [../../policy.md](../../policy.md).
