...
| P03-T02 | Phase-file rigor: In-scope/Out-of-scope + Automatic/Manual validations | Plan step 2: define-phase's output structure + validate-work-full's phase-validation steps | — | validating |
