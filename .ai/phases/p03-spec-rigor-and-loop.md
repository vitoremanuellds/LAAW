...
| P03-T03 | Document the spontaneous-phase-planning pattern | Plan step 3: name the bare-roadmap-row → define-phase pattern in workflow.md/README.md, using P02 as the worked example | — | validating |
