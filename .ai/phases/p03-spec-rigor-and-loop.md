...
| P03-T04 | Closing-loop questions in propagate-context | Plan step 4: propagate-context.task asks if the phase needs more tasks; propagate-context.project asks if the project needs another phase | — | awaiting-plan-review |
