...
|---|---|---|---|---|
| P03-T01 | Task-file rigor: In-scope/Out-of-scope + Automatic/Manual validations | Plan step 1: define-task-full's output structure + implement-task-full's flexibility language + workflow.md §6's deviation definition | — | awaiting-plan-review |
