...
| P06-T11 | Add an explicit context-resolution search-order rule | New rule: follow the task/phase file's own links first, don't search the codebase for context docs | — | validating |
