...
| P06-T09 | Migrate commit-step detail into each of the 8 full-profile skills; trim the commit-discipline section to one line | Drop the Conventional-Commits mandate from workflow.md; keep "commit each draft immediately" as the one cross-cutting rule | — | reviewing |
