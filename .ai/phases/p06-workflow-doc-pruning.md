...
| P06-T12 | Apply remaining confirmed-safe trims (opening/§1, §3, §4 glossary, §9) | Low-risk cleanup already confirmed safe against reference/ and propagate-context's existing content | — | validating |
