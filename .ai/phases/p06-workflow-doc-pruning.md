...
| P06-T10 | Define an inline in-task-file deviation convention; update §6 | Replace the separate deviation-file mechanism, precedented by lite/minimal's inline field | P06-T01 | in-progress |
