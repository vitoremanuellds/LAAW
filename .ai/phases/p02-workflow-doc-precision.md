...
| P02-T04 | Add "anything else to add?" step to planning skills | Plan step 4 (E): create-constitution-full, define-phase, define-task-full each get this sub-step before their gate-stop | — | validating |
