...
Steps 3 and 4 are independent of 1/2 and of each other — safe to do in
any order or in parallel once 1/2 land, since none of them touch
...
three skills' procedures, additive sub-steps only).
