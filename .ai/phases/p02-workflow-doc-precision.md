...
| P02-T03 | info.md/roadmap.md layout fix | Plan step 3 (D): profile: full field, tables/status moved after their explanatory prose, in info-template.md, create-constitution-full's roadmap.md step, and this project's own .ai/info.md + roadmap.md | — | validating |
