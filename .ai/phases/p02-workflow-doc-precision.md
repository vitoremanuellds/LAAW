...
| P02-T02 | Add append-not-replan mechanism | Plan step 2 (C): workflow.md §6 addition + define-phase/define-task-full "When to use" clarification (scope narrowed at task-planning — mostly framing, not new mechanism) | P02-T01 (complete) | validating |
