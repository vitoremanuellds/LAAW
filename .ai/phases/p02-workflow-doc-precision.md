...
|---|---|---|---|---|
| P02-T01 | Restructure workflow.md into core + reference/, fix all cross-references | Plan step 1 (A+B): trim core to what-is only, new compact gate-list format, build .ai/workflow/reference/, sweep every cross-reference in skills/*-full, README.md, and the 4 Full templates | — | awaiting-plan-review |
